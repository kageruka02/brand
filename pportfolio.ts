const paragraphInput: HTMLInputElement = document.getElementById(
  "paragraphInput"
) as HTMLInputElement;
const formElement: HTMLFormElement = document.getElementById(
  "form"
) as HTMLFormElement;
const subjectElement: HTMLInputElement = document.getElementById(
  "subject"
) as HTMLInputElement;
...
const lastNameInput: HTMLInputElement = document.getElementById(
  "lastname"
) as HTMLInputElement;
const emailErrorElement: HTMLElement | null =
  document.getElementById("emailerror");
const emailLoginInput: HTMLInputElement = document.getElementById(
  "emaillogin"
) as HTMLInputElement;
const textErrorElement: HTMLElement | null = document.getElementById("text");
const passwordBoxInput: HTMLInputElement = document.getElementById(
  "password"
) as HTMLInputElement;
const passwordWordElement: HTMLElement | null =
  document.getElementById("passwordWord");
...
const dashboardContact: HTMLElement | null =
  document.getElementById("dashboardContact");
const contact: HTMLElement | null = document.getElementById("contact");
const dashboardSkills: HTMLElement | null =
  document.getElementById("dashboardSkills");
const skills: HTMLElement | null = document.getElementById("skills");
const projectBlogId: HTMLElement | null =
  document.getElementById("projectsblogid");
const readmorebutton: NodeListOf<HTMLElement> =
  document.querySelectorAll(".read");
const othertext: NodeListOf<HTMLElement> =
  document.querySelectorAll(".othertext");
...
function clickTheBlog() {
  const ArrayOfBlogs: NodeListOf<HTMLElement> =
    document.querySelectorAll(".readmoreblog");
