const inputdashboard: HTMLInputElement | null = document.getElementById('inputdashboard') as HTMLInputElement;
/*title place*/
const paragraphdashboard: HTMLInputElement | null = document.getElementById('paragraphdashboard') as HTMLInputElement;
/*paragraph on create article*/
let footerdashboard: HTMLInputElement | null = document.getElementById('footer') as HTMLInputElement;
/*footer*/
const senddashboard: HTMLElement | null = document.getElementById('senddashboard');
/*the send button*/
const formdashboard: HTMLFormElement | null = document.getElementById('formdashboard') as HTMLFormElement;
const thewholeedittable: HTMLElement | null = document.getElementById('thewholeedittable');
let checking: string = '';
const inputdashboardedit: HTMLInputElement | null = document.getElementById('inputdashboardedit') as HTMLInputElement;
const paragraphdashboardedit: HTMLInputElement | null = document.getElementById('paragraphdashboardedit') as HTMLInputElement;
const footerdashboardedit: HTMLInputElement | null = document.getElementById('footeredit') as HTMLInputElement;
...
let tablecreatearticle: HTMLElement | null = document.getElementById('thewholecreatetable');
//tablecreatearticle.style.display = 'none';
//table.style.display = 'none';
const originalDisplay: string | null = window.getComputedStyle(thewholeedittable!).display;
thewholeedittable!.style.display = 'none';
tablecreatearticle!.style.display = 'none';
//table.style.display = 'none';
const dashboardbutton: HTMLElement | null = document.getElementById('dashboardbutton');
const newarticlebutton: HTMLElement | null = document.getElementById('newarticlebutton');
const messagesbutton: HTMLElement | null = document.getElementById('messagesbutton');
let themessagedash: HTMLElement | null = document.getElementById('themessagedash');
...
let displayMessageId: HTMLElement | null = document.getElementById('displayMessageId');
...
function activateEditListeners(): void {
    const editBtn: NodeListOf<HTMLButtonElement> = document.querySelectorAll('.blogpagess');
...
function activatePublishListeners(): void {
    ...
    sendii!.addEventListener('click', e => {
       ...
       // console.log(itemsArray[k]);
        if (inputdashboardedit!.value.toString() !== '' || paragraphdashboardedit!.value.toString() !== '') {
         ...
         //   localStorage.setItem('items', JSON.stringify(itemsArray));
           ...
           fetch(`https://backend-fwkm.onrender.com/blogss/${blogId}`, {
            method: "PATCH",
            headers: {
...
const itemsArray: any[][] = localStorage.getItem('items') ? JSON.parse(localStorage.getItem('items')!) : [];
...
function validpassword(): boolean {
    const thepasswordarray: string[] | null = JSON.parse(localStorage.getItem('password')!);
...
function activatereplybutton(): void {
    ...
    replybutton.forEach((e, index) => {
        e.addEventListener('click', () => {
            ...
            window.open(`mailto:${themessages[index].email}?subject=Subject&body=${encodeURIComponent(bodyText)}`);
...
function deletemessage(): void  {
    ...
    deletebutton.forEach((e, index) => {
        ...
        fetch(`https://backend-fwkm.onrender.com/messages/${id}`, {
            method: 'DELETE'
        })
        .then(response => {
            if (!response.ok) {
