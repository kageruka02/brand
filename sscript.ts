...
const emaill: HTMLInputElement | null = document.getElementById(
  "emaillogin"
) as HTMLInputElement;
const texterror: HTMLElement | null = document.getElementById("text");
const passwordBox: HTMLInputElement | null = document.getElementById(
  "password"
) as HTMLInputElement;
const passwordWord: HTMLElement | null =
...
function validateEmail(): boolean {
  if (
    !emaill!.value.match(/^[A-Za-z\._\-0-9]*[@][A-Za-z]*[\.][a-z]{2,4}$/) &&
    emaill!.value.trim() !== ""
  ) {
